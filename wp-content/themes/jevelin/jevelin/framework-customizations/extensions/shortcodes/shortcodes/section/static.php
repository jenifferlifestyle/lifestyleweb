...
if(!function_exists('jevelin_shortcode_section_css')) :
	function jevelin_shortcode_section_css ($data) {
		...
		ob_start(); ?>
			...
			<?php if( isset($atts['strech_edge']) && $atts['strech_edge'] != 'disabled' ) : ?>
				<?php if( $atts['strech_edge'] == 'left' ) : ?>
					@media (min-width: 800px) {
						.sh-section-<?php echo esc_attr( $atts['id'] ); ?> .fw-row .sh-column:first-child > .sh-column-wrapper {
				...
				<?php elseif( $atts['strech_edge'] == 'right' ) : ?>
					@media (min-width: 800px) {
						.sh-section-<?php echo esc_attr( $atts['id'] ); ?> .fw-row .sh-column:first-child > .sh-column-wrapper {
