					...
					<?php if( jevelin_option('contact_phone') ) : ?>
                        <div class="header-contacts-details-large">
                            ...
                            <div class="header-contacts-details-large-content">
                                ...
                                <?php echo esc_attr( jevelin_option('contact_phone') ); ?>
                            </div>
                        </div>
					<?php endif; ?>
					<?php if( jevelin_option('contact_email') ) : ?>
                        <div class="header-contacts-details-large">
                            ...
                            <div class="header-contacts-details-large-content">
                                ...
                                <?php echo esc_attr( jevelin_option('contact_email') ); ?>
                            </div>
                        </div>
					<?php endif; ?>
					<?php if( jevelin_option('contact_location') ) : ?>
                        <div class="header-contacts-details-large">
                            ...
                            <div class="header-contacts-details-large-content">
                                ...
                                <?php echo esc_attr( jevelin_option('contact_location') ); ?>
                            </div>
                        </div>
					<?php endif; ?>
					<?php if( jevelin_option('contact_workhours') ) : ?>
                        <div class="header-contacts-details-large">
                            ...
                            <div class="header-contacts-details-large-content">
                                ...
                                <?php echo esc_attr( jevelin_option('contact_workhours') ); ?>
                            </div>
                        </div>
					<?php endif; ?>
